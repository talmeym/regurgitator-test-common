...
class MqExtensionsLoaderTestExpectations {
    ...
    static final String CreateJmsResponse_multipleProcessor = "com.emarte.regurgitator.extensions.mq.CreateJmsResponse:[com.emarte.regurgitator.core.CreateResponse:['create-jms-response-1',com.emarte.regurgitator.core.ValueSource:[null,'value'],[com.emarte.regurgitator.test.stuff.TestValueProcessor:[], com.emarte.regurgitator.test.stuff.TestValueProcessor:[]]],'message-id','type','destination','correlation-id',1,2,3,true,'reply-to',123456789]";
